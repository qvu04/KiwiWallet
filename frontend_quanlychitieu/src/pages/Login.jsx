    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      ...
      >
        <div className="mb-6 flex flex-col items-center gap-2">
          ...
          <p className="text-sm text-slate-500">Quản lý chi tiêu cá nhân của bạn</p>
        </div>
        ...
        <p className="mt-4 text-center text-sm text-slate-500">
          Chưa có tài khoản?{' '}
          <Link to="/dang-ky" className="font-semibold text-brand-500 hover:underline">Đăng ký ngay</Link>
        </p>
      </motion.div>
    </div>
  );
